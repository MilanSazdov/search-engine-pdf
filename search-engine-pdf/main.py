...
# Author: Milan Sazdov, 21.06.2024. - Search Engine for PDF files, second project for the course Algorithms and Data Structures
# GitHub: MilanSazdov: https://github.com/MilanSazdov/search-engine-pdf/blob/main/main.py - full solution
...
PDF_PATH = r"C:\Users\milan\OneDrive\Desktop\Data Structures and Algorithms in Python.pdf"
OFFSET = 22  # Offset for first 22 not numbered pages (pages without number)
...
def search_menu():
    ...
    while True:
        # Rules for search
        print("\033[94m- For search just type word or word space word ... -\033[0m")
        print("\033[94m- For exit just type exit in the search query -\033[0m")
        print("\033[94m- Use \"first second third ... \" to search the phrase -\033[0m")
        print("\033[94m- Use NOT, OR, NOT for more complex search -\033[0m")
        print("\033[94m- Use * after word for autocomplete (fun* -> function, functionality ...) -\033[0m")
        ...
        if not results and not has_logical_operators or len(results) < 3:  # If no results and no logical operators, suggest similar words
            similar_words = []
            for token in parsed_query:
